...
PLOTS_DIR="plots/sfactor_${R_VALUE}/workload"
mkdir -p "$PLOTS_DIR"
 
for day in "${DAYS[@]}"; do
    for type in "${TYPES[@]}"; do
        num_jobs="${SCENARIO_NJOBS[$type]}"
        workload_file="$WORKLOAD_DIR/${day}_${type}_${num_jobs}_r${R_VALUE}.json"
...
#     PLOTS_DIR="plots/sfactor_${r_val}/workload"
#     mkdir -p "$PLOTS_DIR"
